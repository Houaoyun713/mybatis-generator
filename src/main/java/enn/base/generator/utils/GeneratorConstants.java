...
public enum GeneratorConstants {
	GENERATOR_TOOLS_CLASS("generator_tools_class", (String)null, "用于控制存放在生成器中的工具类,以便在模板中使用 StringUtils"),
	GENERATOR_INCLUDES("generator_includes", (String)null, ""),
	GENERATOR_EXCLUDES("generator_excludes", (String)null, ""),
	...
	TABLE_REMOVE_PREFIXES("tableRemovePrefixes", (String)null, "需要移除的表名前缀,示例值: t_,v_"),
	...
	JDBC_USERNAME("jdbc_username", (String)null, "数据源:用户名"),
	JDBC_PASSWORD("jdbc_password", (String)null, "数据源:密码"),
	JDBC_DRIVER("jdbc_driver", (String)null, "数据源:驱动"),
	JDBC_URL("jdbc_url", (String)null, "数据源:URL"),
	JDBC_SCHEMA("jdbc_schema", (String)null, "数据源:schema"),
	JDBC_CATALOG("jdbc_catalog", (String)null, "数据源:catalog"),
	DATA_SOURCE_JNDI_NAME("data_source_jndi_name", (String)null, "数据源的jndi名称,用于加载数据源"),
	DATABASE_TYPE("databaseType", (String)null, "数据库类型，模板中引用可以用于控制如：分页语句的生成，不同的数据库生成不同的分页语法"),
	...
	private GeneratorConstants(String code, String defaultValue, String desc) {
		this.code = code;
