...
public class JavaClass
{
	...
	public Set<JavaClass> getPropertiesImportClasses()
			throws Exception
	{
	...
	public JavaProperty[] getReadProperties()
			throws Exception
	{
	...
	public JavaProperty[] getWriteProperties()
			throws Exception
	{
		List result = new ArrayList();
		for (JavaProperty p : getProperties()) {
	...
	{
		Set<JavaMethod.FieldMethodInvocation> set = new LinkedHashSet();
